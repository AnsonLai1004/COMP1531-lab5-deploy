...
def calculate_final_score(config, test_score, coverage_score, lint_score):
    ...
    if sum([test_factor, coverage_factor, lint_factor]) > 1:
        ...
        raise SystemExit("ERROR: Sum of scal factors cannot be greater than 1!")
...
def get_coverage_score_from_json():
    try:
        ...
        print(" \n> WARNING: Failed to measure coverage\n ")
        sys.stdout.flush()
...
if __name__ == '__main__':
    ...
    print(f"Testing {CI_PROJECT_NAME}")
